...
import { Options } from 'ngx-google-places-autocomplete/objects/options/options';import { MatDialogRef } from '@angular/material/dialog';
;
...
export class MapsComponent implements OnInit {
  ...
  constructor(
    ...
    public dialogo: MatDialogRef<MapsComponent>,
    ) {
  }
  ...
  save(): void{
    if(this.coordenadas){
      this.dialogo.close(this.coordenadas);
    }
  }
}
